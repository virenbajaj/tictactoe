...
class GamePlay(StateMachineProgram):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu May  4 19:50:43 2017:
        ...
        completiontrans6 .add_sources(placechip1) .add_destinations(forward2)
        ...
        completiontrans7 .add_sources(gotostart2) .add_destinations(say1)
