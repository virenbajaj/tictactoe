...
class GamePlayX(StateMachineProgram): 
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Wed May 10 15:45:36 2017:
        ...
        animationnode2 = AnimationNode(anim_name='anim_dizzy_reaction_medium_02') .set_name("animationnode2") .set_parent(self)
        ...
        animationnode3 = AnimationNode(anim_name='anim_greeting_happy_01') .set_name("animationnode3") .set_parent(self)
        ...
        completiontrans6 .add_sources(sendmessage2) .add_destinations(animationnode2)
        ...
        datatrans4 .add_sources(wait) .add_destinations(animationnode4)
        
        datatrans5 = DataTrans('XO') .set_name("datatrans5")
        datatrans5 .add_sources(wait) .add_destinations(animationnode5)
